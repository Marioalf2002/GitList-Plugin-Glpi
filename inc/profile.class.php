...
class PluginGitlistProfile extends Profile {
    ...
    public static function getAllRights() {
        ...
        return array(
            array(
                'itemtype' => 'PluginGitlistProfile',
                'label' => $LANG['plugin_gitlist']['manage_alerts'],
                'field' => 'plugin_gitlist'
            ),
        );
    }
    ...
    public static function changeProfile() {
        ...
        if ($profile->getFromDBByProfile($_SESSION['glpiactiveprofile']['id'])) {
            $_SESSION['glpiactiveprofile']['gitlist_alert'] = $profile->getField('alert');
        } else {
            unset($_SESSION['glpiactiveprofile']['gitlist_alert']);
        }
    }

    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0) {
        global $LANG;
        return $LANG['plugin_gitlist']['title'];
    }
    ...
    public function showForm($profiles_id, $options = array()) {
        ...
        $profile->displayRightsChoiceMatrix($rights, array(
            ...
            'title' => $LANG['plugin_gitlist']['title'],
        ));
